////
////  CalendarCollectionViewController1.swift
////  Smile_4_Life
////
...
//    calendarView.calendarUserHygieneEvents = viewModelMainView.getAllHygieneEventsByCalendarUser(calendarUser: currentCalendarUser!)
